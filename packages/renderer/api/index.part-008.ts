...
import { renderer_createGpuFramePool_57, renderer_getGpuOutputCapabilities_55, renderer_renderGpuFrame_56 } from './index.part-010'
import type { GpuFrameLease, GpuFramePool, GpuFramePoolOptions, GpuOutputCapabilities } from './gpu-output'
...
export class Renderer {
  ...
  /** @deprecated Use createGpuFramePool() for non-blocking, reusable real-time output. */
  ...
  createGpuFramePool(options: GpuFramePoolOptions): GpuFramePool {
    return renderer_createGpuFramePool_57.call(this, options)
  }
