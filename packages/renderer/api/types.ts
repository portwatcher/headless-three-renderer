...
export interface RenderTargetLike {
  ...
  /** Optional normalized depth readback texture-like target. FloatType receives Float32Array data; unsigned depth types receive scalar unsigned typed arrays; plain objects receive RGBA8 bytes. */
