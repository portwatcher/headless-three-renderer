...
pub(super) struct RendererLayouts {
    ...
    pub(super) normal_map_layout: wgpu::BindGroupLayout,
    pub(super) mr_map_layout: wgpu::BindGroupLayout,
    pub(super) emissive_map_layout: wgpu::BindGroupLayout,
    pub(super) ao_map_layout: wgpu::BindGroupLayout,
    pub(super) shadow_layout: wgpu::BindGroupLayout,
    pub(super) ibl_layout: wgpu::BindGroupLayout,
    pub(super) post_layout: wgpu::BindGroupLayout,
    pub(super) background_layout: wgpu::BindGroupLayout,
}

pub(super) fn create_renderer_layouts(device: &wgpu::Device) -> RendererLayouts {
        ...
        entries: &[
            ...
            wgpu::BindGroupLayoutEntry {
                ...
                ty: wgpu::BindingType::Buffer {
                    ...
                    has_dynamic_offset: false,
                    min_binding_size: wgpu::BufferSize::new(
                        std::mem::size_of::<BackgroundUniforms>() as u64,
                    ),
                },
                count: None,
            },
