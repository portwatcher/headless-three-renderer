...
- `Renderer.isWebGLRenderer` is exposed for Three.js helper branches that use WebGLRenderer-compatible readback signatures, while WebGL context access still fails clearly
