...
- dashed line material segments honor dash/gap/scale settings and preserve selected map UV channels and interpolated vertex colors for common `LineDashedMaterial` cases, including instanced line geometry
