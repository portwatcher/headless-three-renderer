...
- `THREE.BufferGeometry` positions, indices, normals, and UV coordinates, with malformed attribute/data containers and invalid attribute values failing clearly
