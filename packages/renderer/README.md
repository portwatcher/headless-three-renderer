...
- vertex colors
- scene background color plus 2D, equirectangular, and raw six-face cube texture backgrounds with `backgroundIntensity`, 2D texture blur, equirectangular/cube `backgroundRotation`, and equirectangular `environmentRotation`; PMREM/CubeUV backgrounds and unsupported background rotations fail clearly
