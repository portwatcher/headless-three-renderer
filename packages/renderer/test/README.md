...
- **`scale.test.mjs`** — 900-mesh, mixed raw-texture/light mesh, many-instance, raw texture-heavy, encoded texture-heavy, and supported 64-light budget scenes render; generated NodePerformanceTest-shaped glTF graphs with 10,000 nodes/meshes/materials/texture definitions load; and larger visible non-ambient light sets fail clearly.
