...
- **`scale.test.mjs`** — 1,600-mesh, mixed 100-mesh raw-texture/light, 5,625-instance, 169-map raw texture-heavy, 121-map encoded texture-heavy, and supported 64-light budget scenes render; generated NodePerformanceTest-shaped glTF graphs with 10,000 nodes/meshes/materials/texture definitions load; and larger visible non-ambient light sets fail clearly.
