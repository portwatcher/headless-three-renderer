...
- **`scale.test.mjs`** — 1,024-mesh, mixed raw-texture/light mesh, 4,096-instance, 121-map raw texture-heavy, 81-map encoded texture-heavy, and supported 64-light budget scenes render; generated NodePerformanceTest-shaped glTF graphs with 10,000 nodes/meshes/materials/texture definitions load; and larger visible non-ambient light sets fail clearly.
