...
- **`scale.test.mjs`** — 1,936-mesh, 2,048-group nested hierarchy plus 256 visible meshes, mixed 144-mesh raw-texture/light, 7,056-instance, 2,048-BatchedMesh packed-instance, 4,096-point billboard, 2,048-sprite billboard, 4,032-wide-line-segment, 225-map raw texture-heavy, 169-map encoded texture-heavy, 512 x 512 raw texture, 512 x 512 output-size, and supported 64-light budget scenes render; generated NodePerformanceTest-shaped glTF graphs with 10,000 nodes/meshes/materials/texture definitions load; and larger visible non-ambient light sets fail clearly.
