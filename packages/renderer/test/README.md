...
- **`gltf.test.mjs`** — committed local glTF fixtures load geometry/materials and encoded data-URI textures through the exported local glTF helper, including the loader plugin/configuration hook, and render through the documented Node loader setup.
