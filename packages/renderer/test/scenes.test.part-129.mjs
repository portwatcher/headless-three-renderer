...
test('reusable renderer reflects mutated material envMap texture bytes', () => {
  ...
  assert.ok(red.r > red.g + 20, `initial material envMap should reflect red bytes (${red.r} vs ${red.g})`)
  assert.ok(green.g > green.r + 20, `mutated material envMap should reflect green bytes (${green.g} vs ${green.r})`)
