...
- Environment IBL from equirectangular or cube `scene.environment`/reflection probes, plus single shared material-level reflection env maps for supported IBL material paths, including `MeshBasicMaterial` legacy combine/reflectivity handling.
