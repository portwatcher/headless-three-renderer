...
| Shadow behavior parity | High | Common `shadow.camera`, rectangular directional/spot/cascaded map sizes, square point-light cube-face maps, bias, normal bias, cast/receive rules, and alpha-tested casters are supported; non-square point-light shadow map sizes, non-default shadow blur/radius settings, and custom shadow material overrides fail clearly. Remaining work is configurable radius/blur behavior, custom shadow material translation, transparency parity, and deeper golden-tested behavior. |
