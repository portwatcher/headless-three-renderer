...
| Add end-to-end glTF/VRM examples | High | `examples/render-gltf.mjs` renders a local glTF/GLB asset fully in Node using the exported loader helpers, tests render committed geometry/material and encoded-texture glTF fixtures through the exported local glTF helper, and the generated corpus includes a synthetic avatar-style toon/skinned scene. Remaining work is committed glTF Sample Assets plus VRM/VRMA-specific examples and external fixtures. |
