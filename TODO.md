...
- `THREE.Sprite`/`SpriteMaterial` CPU billboard expansion with color, opacity, texture maps, scene fog, center, scale, rotation, size attenuation, layers, render ordering, and directional/spot shadow casting; `receiveShadow` and point-light sprite shadows fail clearly.
