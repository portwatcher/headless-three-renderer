...
| MSAA controls | Medium | Render-option and target sample counts support 4x MSAA with resolve back to normal output and target readback buffers; unsupported sample counts fail clearly. Remaining work is broader WebGL sample-count/state parity and alpha-to-coverage integration. |
