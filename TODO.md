...
- `THREE.InstancedBufferGeometry` CPU expansion for mesh, point, and non-dashed line geometry with common per-instance offset and color attributes.
...
| Task | Impact | Notes |
|---|---:|---|
| `InstancedBufferGeometry` edge cases | High | Basic mesh, point, and non-dashed line CPU expansion supports common per-instance offset/color attributes; remaining work is arbitrary custom vertex attributes, shader integration, and dashed-line parity. |
