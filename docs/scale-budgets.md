...
|---|---:|---|
| Mesh count | 1,296 meshes | `scale.test.mjs` renders a 36 x 36 grid of separate mesh objects with shared lightweight geometry and a small material set. |
...
| Instanced mesh expansion | 4,900 instances | A single `InstancedMesh` renders a 70 x 70 grid with per-instance matrices and colors. |
