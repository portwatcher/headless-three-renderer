...
| Direct lights | 32 visible non-ambient lights | The supported native light-array budget is covered with 32 point lights plus ambient light. |
...
- The direct light limit is a real current renderer limit: more than 32 visible non-ambient lights fail clearly until native light arrays are expanded.
