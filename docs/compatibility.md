...
| `MeshPhysicalMaterial` | Partial | Clearcoat, sheen, anisotropy, specular intensity/color, roughness-aware scene-color transmission, IOR, thickness, attenuation, and related maps are supported. Iridescence and dispersion fail clearly; exact transmission mip/bicubic behavior and several edge cases remain planned. |
